...
**Companion docs:** [case-study-1-meta-ads.md](case-study-1-meta-ads.md) (proof-layer creative C1–C10 + locked fact sheet), [offer-stack-stage1.md](offer-stack-stage1.md) (superseded free-test offer — economics/constraints context still valid), [case-study-1-village-recall.md](case-study-1-village-recall.md) (case-study source of truth).
...
- **No price in ads or on the landing page.** Price is presented only on the sales call, immediately
  after the case-study proof ("$8,000 in production for ~$55 in texts... the pilot is $1,250").
...
5 bookings × ~$250 avg production ≈ $1,250 — the pilot literally pays for itself or it's free.

Why 200 patients and why 5 (case-study base rate 4.9% booked, ~$250 avg production):
...
- **Headline:** "$8,000 in new production from ~$55 in texts — off one practice's overdue list."
...
| **Proof** | ~5 min | Walk the case study: 657 texted, 145 clicked (~22%), 32 booked (~4.9%), ~$8,000 production, ~$55 in texts. Let the numbers do the selling. |
| **Offer** | ~5 min | The 200-Patient Pilot: what the AI does, what they do (one export + copy approval), the guarantee ("fewer than 5 bookings in 30 days, every dollar back"), **then the price — $1,250, first time they hear it, anchored right after the $8,000.** |
...
The proof-layer concepts **C1–C10 and copy banks in [case-study-1-meta-ads.md](case-study-1-meta-ads.md)
...
- **Primary text:** "We take a segment of your overdue list. Our AI texts them, answers their replies
  ...
  patients texted, 32 booked, ~$8,000 in new production for ~$55 in texts. Apply below — takes 60 seconds."
...
- **Primary text:** "Reactivating overdue patients works — nobody has time to do it. Our AI does the
  ...
  person, and books the ready ones. One PPO group got 32 patients back (~$8,000 in production) from one
...
- **Primary text:** "Every name in your overdue report is a patient you already spent money to acquire.
  ...
  ready ones back. 657 texted at one PPO group → 32 booked → ~$8,000 in production, for about $55 in
...
- **Primary text:** "Overdue patients don't stay dormant forever — eventually someone reminds them to
  ...
  replies, and books the ready ones. Real result at one PPO group: 32 booked from 657 texted, ~$8,000 in
...
- **Primary text:** "The fastest way to fill hygiene columns isn't new-patient ads — it's the overdue
  ...
  One PPO group put 32 patients (~$8,000) back on the schedule for ~$55 in texts. If it doesn't book,
  it's free. Apply below."

### O6 — Ridiculous-result *(ridiculous-result call-out · the locked ratio as pure curiosity)*
- **HERO:** $8,000 of dentistry from $55 in text messages.
...
- **Primary text:** "Not a projection — a real result. 657 overdue patients at a 3-location PPO group got
  ...
  1–3%). ~$8,000 in new production for about $55 in text cost. Now it runs on AI, and it can run on your
...
2. $55 of text messages turned into ~$8,000 of dentistry.
...
Never "Get Offer" with dollar language; never promise the viewer a specific result — the $8,000 is the
...
- **Claims:** locked fact sheet only ([case-study-1-meta-ads.md](case-study-1-meta-ads.md) §2). No
