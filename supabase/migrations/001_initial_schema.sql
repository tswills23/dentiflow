-- DentiFlow Speed-to-Lead: Initial Schema Migration
...
-- 1. practices — Dental practice clients (our customers)
...
-- 2. patients — Patient/lead records
...
-- 3. conversations — All message threads
...
-- 5. metrics_daily — Dashboard metrics
...
-- 6. automation_log — Everything the system does
...
-- 7. user_profiles — Auth → practice mapping
...
-- Practice data: users see only their practice's data
