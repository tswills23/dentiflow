...
When a patient replies to a recall sequence and the inbound is NOT a critical intent (opt_out, urgent, wrong_number, slot_selection at S4), the reply may be generated by Claude Sonnet 4.5 instead of the keyword-based template. See [docs/runbook-recall-llm.md](docs/runbook-recall-llm.md) for incident response.
